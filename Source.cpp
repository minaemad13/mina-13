...
using namespace std;
HANDLE h = GetStdHandle(STD_OUTPUT_HANDLE);//for change the color in the console
// the menu of the product on the machine
...
//this fun to check IF the choose is in the machine and Available or not
...
// this fun to add the input coins to the coins in the machine
...
//this  fun to return the Remaining money to the user
...
// this fun for check IF the coins input is equal or bigger or smaller than the price of the product 
